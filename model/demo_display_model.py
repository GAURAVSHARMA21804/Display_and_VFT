...
class demo_display_unit_model():
    def __init__(self):
        try:
            ...
            # self.con2=mysql.connector.connect(host="localhost",user="DU_USER",password="Interface@123",database="DU_APP")
            # self.cur2=self.con2.cursor(dictionary=True)
            # self.con2.autocommit=True
            print("connected successfully")
            ...
            self.pool=mysql.connector.pooling.MySQLConnectionPool(
                ...
                # host="localhost",user="DU_USER",password="Interface@123",database="DU_APP")
